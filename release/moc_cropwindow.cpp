...
QT_MOC_LITERAL(1, 11, 8), // "cropOver"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 11), // "Screenshot*"
QT_MOC_LITERAL(4, 33, 17) // "croppedScreenshot"

    },
    "CropWindow\0cropOver\0\0Screenshot*\0"
    "croppedScreenshot"
};
...
void CropWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CropWindow *_t = static_cast<CropWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cropOver((*reinterpret_cast< Screenshot*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CropWindow::*_t)(Screenshot * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CropWindow::cropOver)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CropWindow::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_CropWindow.data,
      qt_meta_data_CropWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CropWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CropWindow.stringdata0))
        return static_cast<void*>(const_cast< CropWindow*>(this));
...
// SIGNAL 0
void CropWindow::cropOver(Screenshot * _t1)
{
